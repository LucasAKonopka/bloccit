...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it "shows a specific advertisements" do
      get :show , {id: my_advertisement.id}
  ...
  describe "Advertisement create" do
    it "increases the number of advertisements by 1" do
      expect{post :create, advertisement: {title: RandomData.random_sentence , copy: RandomData.random_paragraph, price: RandomData.random_int}}.to change(Advertisement,:count).by(1)
    end
